# Egiftcard Labs Analytics Events
[![npm](https://img.shields.io/npm/v/@egiftcard/analytics-events)](https://www.npmjs.com/package/@egiftcard/analytics-events)

The `@egiftcard/analytics-events` package is a [npm package](https://www.npmjs.com/package/@egiftcard/analytics-events) of constants used as the inputs into our [@egiftcard/analytics](https://www.npmjs.com/package/@egiftcard/analytics) package ([Github Link](https://github.com/Egiftcard/analytics)). It is used in repos such as [interface](https://github.com/Egiftcard/interface) and [docs](https://github.com/Egiftcard/docs).
...
```bash
yarn add @egiftcard/analytics-events
```

```bash
npm i --save @egiftcard/analytics-events
```
...
The [analytics](https://github.com/Egiftcard/analytics) library implements the [Trace framework](https://slack.engineering/creating-a-react-analytics-logging-library/) to enable easy default properties and basic hierarchy of context. The following context properties are available, in order of specificity. This can be used directly for ease or logged manually for custom trigger events.
...
`git restore package.json yarn.lock && rm egiftcard-analytics-events-dev.tgz && yarn`.
...
This will generate a `egiftcard-analytics-events-dev.tgz` including your changes and a `0.0.1` package version number.
