...
export enum InterfaceEventName {
  ...
  EGIFTCARD_WALLET_APP_DOWNLOAD_OPENED = 'Egiftcard Wallet App Download Opened',
  EGIFTCARD_WALLET_MICROSITE_OPENED = 'Egiftcard Wallet Microsite Opened',
  UNIWALLET_CONNECT_MODAL_OPENED = 'Egiftcard wallet modal opened',
