...
export enum InterfaceElementName {
  ...
  DOCS_LINK = 'docs-link',
  EGIFTCARD_WALLET_BANNER_DOWNLOAD_BUTTON = 'egiftcard-wallet-banner-download-button',
  EGIFTCARD_WALLET_CONNECTOR = 'egiftcard-wallet-connector',
  EGIFTCARD_WALLET_LANDING_PAGE_DOWNLOAD_BUTTON = 'egiftcard-wallet-landing-page-download-button',
  EGIFTCARD_WALLET_MODAL_DOWNLOAD_BUTTON = 'egiftcard-wallet-modal-download-button',
  EGIFTCARD_WALLET_NAVBAR_MENU_DOWNLOAD_BUTTON = 'egiftcard-wallet-navbar-menu-download-button',
